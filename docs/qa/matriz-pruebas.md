...
| INV-COUNT-02 | Inventario | Conteo físico de lote/serie | Diferencia de cantidad, identificadores y vencimientos por almacén; detalle obsoleto | Conciliar agregado y detalle, guardar movimiento, compensar fallos y rechazar snapshots obsoletos | Integración `inventory.test.js`: variación de lotes/vencimiento, alta/baja serie y cambio concurrente; aprobada | APROBADO |

Pruebas dirigidas tras completar conteos trazables: 4/4 suites y 104/104 pruebas aprobadas (inventario, compras/ventas, producción y reglas unitarias). Regresión completa final con `npm.cmd test -- --coverage --testTimeout=90000`: **29/29 suites, 461/461 pruebas aprobadas**. Cobertura: líneas 83.41% (3585/4298), ramas 62.10% (1209/1947), funciones 85.45% (552/646). Export web verificada previamente: 243 módulos, bundle 497 kB. Fase 3 APROBADA en código y QA.
