...
**Estado global (2026-09-21)**:
- **Unitarias ✅**: `npm run test:unit` → **18/18 suites, 264/264 pruebas en verde** (Node.js v24.19.0 instalado). Filas #1–#8, #12, #13, #15–#17, #19–#21, #24–#28, #31. Cobertura unitaria de `src/`: 54 % (sube con #9–#30, que ejercitan controllers/servicios/reportes).
- **API + integración ⬜**: requieren `MONGO_URI_TEST` (BD descartable). Ejecutar y pasar a ✅ las filas #9–#11, #14, #18, #22, #23, #29, #30.
...
# Integración (requiere una BD de test DESCARTABLE)
...
| API | #9–#11, #14, #18, #22, #23, #29, #30 (supertest sobre `app.js completo`) — ⬜ pendientes de `MONGO_URI_TEST` |
| Integración | #9–#11, #14, #18, #22, #23, #29, #30 (fixtures reales en MongoDB: tenants + usuarios + roles + almacén) — ⬜ pendientes |
