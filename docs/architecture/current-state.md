...
| Inventario | Stock, movimientos, ajustes, transferencias; conectado a aprobacion de ordenes y produccion; umbrales minimo/maximo y alertas implementados | Kardex y procesos completos | Lotes, series e inventario fisico formal pendientes | Trazabilidad incompleta para articulos controlados | Alta |
