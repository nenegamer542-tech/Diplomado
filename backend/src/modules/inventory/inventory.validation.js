...
const ENTRY_EXIT_FIELDS = ['productId', 'warehouseId', 'quantity', 'reason', 'reference'];
/** Campos permitidos en POST de ajustes (reason obligatorio). */
const ADJUSTMENT_FIELDS = ['productId', 'warehouseId', 'quantity', 'reason', 'reference'];
/** Campos permitidos en POST de transferencias. */
const TRANSFER_FIELDS = ['productId', 'fromWarehouseId', 'toWarehouseId', 'quantity', 'reason', 'reference'];
